...
const drinks = () => {
 ...
 <section className="h-[66]
  ...
  h] p-4 py-7 border-t-4 border-amber-500 bg-slate-900 w-full mx-auto"> 
 <SubHeading titel="Retttungsanker Menu"/>
 <div className="w-7/12 flex flex-col items-center mx-auto">
 <h1 className="text-3xl headingB text-white-500 text-center lg:text-8xl">Drinks & Snacks</h1>
 <h1 className="w-11/12 text-center lg:w-4/12 max-auto text-[.9rem] text-slate-400">Preise gelten wie ausgeschrieben incl. 7% Mwst.</h1>
...
<div className=" mb-10 w-[90vw] flex h-[66vh] justify-center items-center gap-x-3 gap-y-20 mr-auto ml-auto flex-wrap container">
 <div className="bg-black flex w-full h-full justify-center items-center pr-4 pl-4 md:w-[25vw] gap-x-2 md:mb-0">
       ...
       <div className="flex flex-col items start justify-center">
        <p className="text-left lg:text-5xl text-slate-100">Biere</p>
 ...
 <div className="w-10/12 h-full lg:transform lg:translate-y-48">
