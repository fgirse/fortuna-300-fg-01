...
function Infosection() {
  return (
    ...
    <section className="hidden lg:block w-full sticky -top-0 z-50 mx-auto md:bg-amber-800 ">
        <div className="py-6 mx-auto w-full flex flex- justify-around items-end md:flex-row md:items-center md:justify-start md:gap-x-5">
            ...
            <Link href="/" aria-label={siteMetadata.headerTitle}>
              <div className="flex items-center justify-between">
                ...
                {typeof siteMetadata.headerTitle === 'string' ? (
                  <div className="hidden h-6 text-amber-800 font-semibold sm:block">
          ...
          <svg className="w-6 " fill="none" stroke="#fff200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
